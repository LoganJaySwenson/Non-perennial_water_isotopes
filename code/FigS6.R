...
AIMS_isotopes$watershed <- as.factor(AIMS_isotopes$watershed)
AIMS_isotopes$flowing <- as.factor(AIMS_isotopes$flowing)
AIMS_isotopes$ysiWaterTemp <- as.numeric(AIMS_isotopes$ysiWaterTemp)
names(AIMS_isotopes)
...
# Extract conditional permutation variable importance (more robust)
...
ggsave(path = "figures/", "FigS6.png", dpi=300, width = 190, height = 90, units = "mm")