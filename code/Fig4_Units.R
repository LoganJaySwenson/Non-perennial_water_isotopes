...
ggplot()+
  geom_rect(data = limestones, aes(ymax = top, ymin = bottom, xmax = Inf, xmin = -Inf), fill = "#FEF3A3", alpha = 0.4)+
...
ggsave(path = "figures/", "Fig4_LimestoneOutcrops.png", dpi=300, width = 190, height = 90, units = "mm")